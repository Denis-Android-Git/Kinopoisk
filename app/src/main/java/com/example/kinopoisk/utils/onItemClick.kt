...
fun onItemClick(item: MovieForUi, fragment: Fragment) {
    val bundle = Bundle()
...
fun onItemClickTwo(item: Movie, fragment: Fragment) {
    val bundle = Bundle()
    val filmId = item.filmId
    val kinopoiskId = item.kinopoiskId
...
fun onPictureClick(
    category: String, item: Item, imageView: ImageView, fragment: Fragment, id: Int?, index: Int
) {
    val bundle = Bundle()
